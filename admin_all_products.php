...
if (isset($_GET['search'])) {
	$search = $_GET['search'];
	$sql = "SELECT * FROM products WHERE productName LIKE '%$search%' AND uploadedBy = '{$_SESSION['user']['idusers']}'";
} else {
	$sql = "SELECT * FROM products WHERE  uploadedBy = '{$_SESSION['user']['idusers']}'";
}
